...
impl CoddState {
    /// Get the display character for this state
    ...
    /// Get alternative display character for enhanced visual mode
    ...
    pub fn color(self) -> Color {
        match self {
            CoddState::Empty => Color::Rgb(30, 30, 30),
            CoddState::Conductor => Color::Rgb(128, 128, 128),
            CoddState::OrdinaryTransmission => Color::Rgb(0, 255, 0),
            CoddState::SpecialTransmission => Color::Rgb(0, 150, 255),
            CoddState::Confluence => Color::Rgb(255, 255, 0),
            CoddState::OrdinaryReversed => Color::Rgb(255, 100, 100),
            CoddState::SpecialReversed => Color::Rgb(255, 0, 255),
            CoddState::SheathedConductor => Color::Rgb(200, 200, 200),
        }
    }

    /// Get background color for this state
    pub fn bg_color(self) -> Color {
        match self {
            CoddState::Empty => Color::Rgb(10, 10, 10),
            CoddState::Conductor => Color::Rgb(40, 40, 40),
            CoddState::OrdinaryTransmission => Color::Rgb(0, 60, 0),
            CoddState::SpecialTransmission => Color::Rgb(0, 30, 60),
            CoddState::Confluence => Color::Rgb(60, 60, 0),
            CoddState::OrdinaryReversed => Color::Rgb(60, 20, 20),
            CoddState::SpecialReversed => Color::Rgb(60, 0, 60),
            CoddState::SheathedConductor => Color::Rgb(50, 50, 50),
        }
    }
    ...
    pub fn description(self) -> &'static str {
        match self {
            CoddState::Empty => "Empty space - no signal propagation",
            ...
            CoddState::SpecialTransmission => "Special signal - enhanced transmission",
            CoddState::Confluence => "Confluence - signal junction point",
            CoddState::OrdinaryReversed => "Reversed ordinary signal",
            CoddState::SpecialReversed => "Reversed special signal",
            CoddState::SheathedConductor => "Sheathed conductor - protected transmission",
        }
    }
    ...
    /// Get all possible states for cycling through
    ...
    /// Get next state in cycle (for editing)
    pub fn next(self) -> CoddState {
        match self {
            CoddState::Empty => CoddState::Conductor,
            CoddState::Conductor => CoddState::OrdinaryTransmission,
            CoddState::OrdinaryTransmission => CoddState::SpecialTransmission,
            CoddState::SpecialTransmission => CoddState::Confluence,
            CoddState::Confluence => CoddState::OrdinaryReversed,
            CoddState::OrdinaryReversed => CoddState::SpecialReversed,
            CoddState::SpecialReversed => CoddState::SheathedConductor,
            CoddState::SheathedConductor => CoddState::Empty,
        }
    }
